...
import 'package:developer_company/views/cash-advance/accounting/controller/accounting_controller.dart';
...
class AccountingAdvancePage extends StatefulWidget {
  const AccountingAdvancePage({Key? key}) : super(key: key);

  @override
  State<AccountingAdvancePage> createState() =>
      _AccountingAdvancePageState();
}

class _AccountingAdvancePageState extends State<AccountingAdvancePage> {
  late AccountingAdvanceController controller;
  late Responsive responsive;

  @override
  void initState() {
    super.initState();
    controller = Get.put(AccountingAdvanceController());
